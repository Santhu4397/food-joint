...
public class UserController {
	...
	public ResponseEntity<ResponseStructuer<User>> loginStaff(@ApiParam("Login for Owner") @RequestBody Login dto) {
	...
	@ApiResponse(code=500,message = "Internal Server Error")})
	public ResponseEntity<ResponseStructuer<User>> saveUser(@RequestBody User user) {
	...
	@ApiResponses({@ApiResponse(code=200,message="data save to DB"),
		@ApiResponse(code=404,message = "class not found in controller"),
		@ApiResponse(code=500,message = "Internal Server Error")})
	public 	ResponseEntity<ResponseStructuer<User>>  getbyid(@PathVariable int id) {
	...
	@ApiResponses({@ApiResponse(code=200,message="data save to DB"),
		@ApiResponse(code=404,message = "class not found in controller"),
		@ApiResponse(code=500,message = "Internal Server Error")})
	public ResponseEntity<ResponseStructuer<User>> update(@PathVariable int id, @RequestBody User u) {
